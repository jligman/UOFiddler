...
using UoFiddler.Plugin.Regions.Forms;

namespace UoFiddler.Plugin.Regions.UserControls
{
    public class RegionsPlugin : Controls.Plugin.PluginBase
    {
        ...
        /// Name of the plugin
        /// </summary>
        public override string Name { get; } = "Regions";

        /// <summary>
        /// Description of the Plugin's purpose
        /// </summary>
        public override string Description { get; } = "Graphical Region Editor";

        /// <summary>
        /// Author of the plugin
        /// </summary>
        public override string Author { get; } = "NIW";
        ...
        public override void ModifyTabPages(TabControl tabControl)
        {
            ...
            page.Controls.Add(new RegionsControl());
